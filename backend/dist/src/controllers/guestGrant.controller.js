...
exports.revokeGuestGrant = exports.createGuestGrant = exports.getGuestGrants = void 0;
const guestGrant_service_1 = __importDefault(require("../services/guestGrant.service"));
const getGuestGrants = async (req, res) => {
    try {
        ...
        const grants = await guestGrant_service_1.default.getGrants({
            role: userRole,
            employeeId,
            departmentId,
        });
...
exports.getGuestGrants = getGuestGrants;
const createGuestGrant = async (req, res) => {
    try {
        const userRole = req.user.role;
        ...
        const grant = await guestGrant_service_1.default.createGrant({ userId, departmentId, scope }, grantedById, userRole, userDeptId);
        res.status(201).json({
            success: true,
...
exports.createGuestGrant = createGuestGrant;
const revokeGuestGrant = async (req, res) => {
    try {
        ...
        const userRole = req.user.role;
        const userDeptId = req.user.departmentId ? BigInt(req.user.departmentId) : undefined;
        await guestGrant_service_1.default.revokeGrant(grantId, userRole, userDeptId);
        res.json({
            success: true,
...
exports.revokeGuestGrant = revokeGuestGrant;

...
export default function EnrollmentForm({
  ...
  const filteredTeachers = employees.filter((emp) => {
      ...
      <div className={isTeacher ? "pointer-events-none opacity-60 select-none" : ""}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div
            ...
            className={`p-5 rounded-2xl border cursor-pointer transition-all duration-200 relative flex flex-col justify-between ${activeType === "SELF"
          ...
          <div
            ...
            className={`p-5 rounded-2xl border cursor-pointer transition-all duration-200 relative flex flex-col justify-between ${activeType === "ADMIN"
              ? "border-primary bg-primary/5 shadow-md ring-2 ring-primary/20"
              : "border-border bg-card hover:border-primary/50 hover:bg-muted/20"
              }`}
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">2) Select Users</h3>
                <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                  Select the users to be enrolled.
                </p>
              </div>
            </div>
          ...
          {/* Type 3: Bulk Enrolment */}
          <div
            onClick={() => setType("BULK")}
            className={`p-5 rounded-2xl border cursor-pointer transition-all duration-200 relative flex flex-col justify-between ${activeType === "BULK"
              ? "border-primary bg-primary/5 shadow-md ring-2 ring-primary/20"
              : "border-border bg-card hover:border-primary/50 hover:bg-muted/20"
              }`}
          >
            <div className="space-y-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-foreground">3) Bulk Enrolment</h3>
                <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
        ...
        {activeType === "ADMIN" && (
          <div className="rounded-2xl border border-blue-500/30 bg-blue-500/5 p-6 space-y-5">
            ...
            <div className="bg-background rounded-xl p-5 border border-border space-y-4 shadow-sm">
              ...
              {singleMessage && (
                <div
                  className={`p-3 rounded-xl border text-xs font-semibold flex items-center gap-2 ${singleMessage.type === "success"
